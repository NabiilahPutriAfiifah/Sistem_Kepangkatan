...
$query = mysqli_query($conn, "SELECT nama_jabatan, COUNT(*) as jumlah_pegawai FROM jabatan GROUP BY nama_jabatan");
...
<body class="no-skin">
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Rekapitulasi<small> <i class="ace-icon fa fa-angle-double-right"></i> Grafik Jabatan
                            &nbsp;
                        </small>
                    </h1>
                </div>
                ...
                <div style="padding-left: 30px; padding-right: 30px">
                    <div class="col-8 offset-2">
                        <div class="card">
                            <div class="card-body">
                                <h2><b>Grafik Jabatan Pegawai BUMN 2022-2023</b></h2>
                                <hr>
                                <center><div class="chart-container" style="position: relative; height:40vh; width:80vw">
    ...
    <script>
        ...
        type: 'bar',
        data: { 
            labels: <?php echo json_encode($nama_jabatan); ?>,
            datasets: [{
