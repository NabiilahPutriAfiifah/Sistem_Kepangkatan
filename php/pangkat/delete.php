...
if(isset($_POST["id_pangkat"]) && !empty($_POST["id_pangkat"])){
    // Include config file
    require "../../koneksi.php";
    
    // Prepare a delete statement
    $sql = "DELETE FROM pangkat WHERE id_pangkat = ?";
    ...
    if($stmt = mysqli_prepare($conn, $sql)){
        ...
        // Set parameters
        $param_id = trim($_POST["id_pangkat"]);
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Riwayat<small><i class="ace-icon fa fa-angle-double-right"></i> Pangkat <i
                                class="ace-icon fa fa-angle-double-right"></i> Delete Pangkat Pegawai &nbsp; <i
                ...
                <div class="wrapper">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-header">
                                    <h1>Delete Data Pangkat Pegawai</h1>
                                </div>
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    <div class="alert alert-danger fade in">
                                        <input type="hidden" name="id_pangkat"
                                            value="<?php echo trim($_GET["id_pangkat"]); ?>" />
