        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Kenaikan<small><i class="ace-icon fa fa-angle-double-right"></i> Pangkat <i
                            ...
                            <a type="button" class="label label-lg label-light arrowed-in arrowed-right"
                                href="create.php?page=form-master-data-pegawai"><i
                                    class="ace-icon fa fa-plus-circle bigger-110 blue"></i> Add Pangkat Pegawai
                                &nbsp;</a>
                        </small>
                    </h1>
                </div>
                ...
                <div class="wrapper">
                    <div class="container-fluid">
                        <div class="row justify-content-md-center">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header" style="background-color: #307ECC; margin-bottom: 10px">
                                        Results <u><?php $script = "SELECT * FROM pangkat";
                                    ...
                                    <div>
                                        <?php
                                                ...
                                                if(isset($_GET['search'])){
                                                    $search = $_GET['search'];
                                                    $sql = "select * from pangkat WHERE nama_pangkat LIKE '%" .$search. "%' order by id_pangkat Asc limit $posisi, $batas";
                                                }else{
                                                    $sql = "select * from pangkat order by id_pangkat Asc limit $posisi,$batas";
                                                }

                                                
                                                    $sql2 = "SELECT id_pangkat, pegawai.nama as nama, nama_pangkat, golongan, tgl_pangkat FROM pangkat JOIN pegawai on pangkat.id_pegawai=pegawai.id_pegawai limit $posisi,$batas";
                                                    $hasilpegawai = mysqli_query($conn, $sql2);
                                        // $datapegawai = mysqli_fetch_assoc($hasilpegawai);
                                        ...
                                        <table id="dynamic-table"
                                            ...
                                            <?php
                                                if (mysqli_num_rows($hasilpegawai) > 0) :
                                                ?>
                                            <?php
                                                while($datapegawai = mysqli_fetch_assoc($hasilpegawai)):
                                                ?>

                                            <tbody>
                                                <tr>
                                                    <td><?= $datapegawai['id_pangkat']; ?></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <p class="form-control-static">
                                                            <?= $datapegawai['nama_pangkat']; ?>
                                                    </td>
                                                    <td>
                                                        <p class="form-control-static"><?= $datapegawai['golongan']; ?>
                                                    </td>
                                                    <td>
                                                        <p class="form-control-static">
                                                            <?= $datapegawai['tgl_pangkat']; ?>
                                                    </td>
                                                    <td class="center">
                                                        <div class="hidden-sm hidden-xs btn-group">
                                                            <a type="button"
                                                                class="btn btn-xs btn btn-white btn-success btn-bold"
                                                                href="read_detail.php?id_pangkat=<?= $datapegawai["id_pangkat"]; ?>"
                                                                title="detail"><i
                                                                    class="ace-icon fa fa-folder-open-o bigger-120"></i></a>
                                                            <a type="button"
                                                                class="btn btn-xs btn btn-white btn-info btn-bold"
                                                                href="update.php?id_pangkat=<?= $datapegawai["id_pangkat"]; ?>"
                                                                title="edit"><i
                                                                    class="ace-icon fa fa-pencil bigger-120"></i></a>
                                                            <a type="button"
                                                                class="btn btn-xs btn btn-white btn-danger btn-bold"
                                                                href="delete.php?id_pangkat=<?= $datapegawai["id_pangkat"]; ?>"
                                                                title="delete"
                                        ...
                                        if(isset($_GET['search'])){
                                            $search = $_GET['search'];
                                            $query2="select * from pangkat WHERE nama_pangkat LIKE '%$search%' order by id_pangkat Asc";
                                        }else{
                                            $query2="select * from pangkat order by id_pangkat Asc";
                                        }
