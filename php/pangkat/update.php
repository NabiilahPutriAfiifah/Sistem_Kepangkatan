        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Kepegawaian<small><i class="ace-icon fa fa-angle-double-right"></i> Pangkat <i
                                class="ace-icon fa fa-angle-double-right"></i> Pangkat Pegawai &nbsp; <i
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        if($_GET['id_pangkat'] == null){
                            ...
                            $script = "SELECT * FROM pangkat WHERE id_pangkat = $id_pangkat";
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            //     $id_pegawai = $id['id_pegawai'];
                                ...
                                $tgl_pangkat = $_POST['tgl_pangkat'];
                                
                                $script = "UPDATE pangkat SET id_pegawai='$id_pegawai', nama_pangkat='$nama_pangkat' , golongan='$golongan', tgl_pangkat='$tgl_pangkat' WHERE id_pangkat='$id_pangkat'";
                        ...
                        <form method="post" action="" class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <?php 
                                            $sql2 = "SELECT nama FROM pegawai WHERE id_pegawai=$id_pegawai";
                                    ...
                                    <label
                                        class="col-sm-4 control-label no-padding-left"><b><?= $data2['nama'] ?></b></label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Nama Pangkat Pegawai</label>
                                <div class="col-sm-6">
                                    <input type="text" name="nama_pangkat" maxlength="24"
                                        placeholder="Nama Pangkat Pegawai" class="col-xs-10 col-sm-12"
                                        value="<?= $data['nama_pangkat'] ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Golongan Pegawai</label>
                                <div class="col-sm-6">
                                    <select name="golongan" class="chosen-select form-control"
                                        data-placeholder="Choose a Golongan Pegawai...">';
                                        <option value=""> </option>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Tanggal Kenaikan Pangkat</label>
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        <input type="date" name="tgl_pangkat" placeholder="Tanggal Kenaikan Pangkat"
                                            class="form-control date-picker" data-date-format="yyyy-mm-dd" />
                                        <span class="input-group-addon"><i class="fa fa-calendar bigger-110"
                                                value="<?= $datapegawai['tgl_pangkat'] ?>"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
