...
if($_GET['id_gaji'] != null){
    ...
    $script = "SELECT id_gaji, pegawai.foto as foto, pegawai.nama as nama, pegawai.nip as nip, gaji, tgl_gaji FROM gaji JOIN pegawai on gaji.id_pegawai=pegawai.id_pegawai WHERE id_gaji=$id_gaji";
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Data<small><i class="ace-icon fa fa-angle-double-right"></i> Gaji <i
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <h4 class="blue"><span class="label label-lg label-purple arrowed-in-right">&nbsp;
                                        &nbsp; # Gaji Pegawai &nbsp; &nbsp;</span></h4>

                                <div class="profile-info-row">
                                    <div class="profile-info-name"> ID Gaji </div>
                                    <div class="profile-info-value"><span><?= $data['id_gaji'] ?></span></div>
                                </div>
                                <div class="profile-info-row">
                                ...
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value"><span>Rp <?=  number_format($data['gaji']) ?></span>
                                    </div>
                                </div>
                                <div class="profile-info-row">
                                    <div class="profile-info-name"> Tanggal Kenaikan Gaji </div>
                                    <div class="profile-info-value"><span><?= $data['tgl_gaji'] ?></span></div>
                                </div>
                            </div>
