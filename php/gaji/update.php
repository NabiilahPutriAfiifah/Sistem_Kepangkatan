        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Riwayat<small><i class="ace-icon fa fa-angle-double-right"></i> Gaji <i
                                class="ace-icon fa fa-angle-double-right"></i> Update Gaji Pegawai &nbsp; <i
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <?php
                        if($_GET['id_gaji'] == null){
                            header("location:read.php");
                        }
                            $id_gaji = $_GET['id_gaji'];
                            $script = "SELECT * FROM gaji WHERE id_gaji = $id_gaji";
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            //     $id_pegawai = $id['id_pegawai'];
                                $gaji = $_POST['gaji'];
                                $tgl_gaji_create = $_POST['tgl_gaji_create'];
                                
                                $script = "UPDATE gaji SET id_pegawai=$id_pegawai, gaji=$gaji, tgl_gaji='$tgl_gaji_create' WHERE id_gaji='$id_gaji'";

                                // $script = "UPDATE gaji SET 
                                // gaji='$gaji',
                                // tgl_gaji_create='$tgl_gaji_create' 
                        ...
                        <form method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Gaji Pegawai</label>
                                <div class="col-sm-6">
                                    <input type="number" name="gaji" maxlength="24" placeholder="Gaji"
                                        class="col-xs-10 col-sm-12" value="<?= $data['gaji'] ?>" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label no-padding-right">Tanggal Kenaikan Gaji</label>
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        <input type="date" name="tgl_gaji_create" placeholder="Tanggal Kenaikan Gaji"
                                            class="form-control date-picker" data-date-format="yyyy-mm-dd" />
                                        <span class="input-group-addon"><i class="fa fa-calendar bigger-110"
                                                value="<?= $datapegawai['tgl_gaji_create'] ?>"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
