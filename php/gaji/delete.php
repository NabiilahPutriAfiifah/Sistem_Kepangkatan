            ...
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Riwayat<small><i class="ace-icon fa fa-angle-double-right"></i> Gaji <i
                                class="ace-icon fa fa-angle-double-right"></i> Delete Gaji Pegawai &nbsp; <i
                ...
                <div class="wrapper">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-header">
                                    <h1>Delete Data Gaji Pegawai</h1>
                                </div>
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    <div class="alert alert-danger fade in">
                                        <input type="hidden" name="id_gaji"
                                            value="<?php echo trim($_GET["id_gaji"]); ?>" />
