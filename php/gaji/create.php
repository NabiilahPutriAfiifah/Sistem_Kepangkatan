        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Kepegawaian<small><i class="ace-icon fa fa-angle-double-right"></i> Gaji <i
                                class="ace-icon fa fa-angle-double-right"></i> Gaji Pegawai &nbsp; <i
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $sql = "INSERT INTO gaji(id_pegawai, gaji, tgl_gaji) VALUES($id_pegawai, $gaji, '$tgl_gaji_create')";
