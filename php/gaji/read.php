        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Kenaikan<small><i class="ace-icon fa fa-angle-double-right"></i> Gaji <i
                            ...
                            <a type="button" class="label label-lg label-light arrowed-in arrowed-right"
                                href="create.php?page=form-master-data-pegawai"><i
                                    class="ace-icon fa fa-plus-circle bigger-110 blue"></i> Add Gaji Pegawai &nbsp;</a>
                        </small>
                    </h1>
                </div>
                <div class="row">
                ...
                <div class="wrapper">
                    <div class="container-fluid">
                        <div class="row justify-content-md-center">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header" style="margin-bottom: 10px"> Results <u><?php $script = "SELECT * FROM gaji";
                                    ...
                                    <div>
                                        <?php
                                                ...
                                                if(isset($_GET['search'])){
                                                    $search = $_GET['search'];
                                                    $sql = "select * from gaji WHERE gaji LIKE '%" .$search. "%' order by id_gaji Asc limit $posisi, $batas";
                                                }else{
                                                    $sql = "select * from gaji order by id_gaji Asc limit $posisi,$batas";
                                                }

                                                
                                                    $sql2 = "SELECT id_gaji, pegawai.nama as nama, gaji, tgl_gaji FROM gaji JOIN pegawai on gaji.id_pegawai=pegawai.id_pegawai limit $posisi,$batas";
                                        ...
                                        <table id="dynamic-table"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">TANGGAL KENAIKAN GAJI</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="form-control-static">Rp
                                                            <?= number_format($datapegawai['gaji']); ?></p>
                                                    </td>
                                                    <td>
                                                        <p class="form-control-static"><?= $datapegawai['tgl_gaji']; ?>
                                                        </p>
                                                    </td>
                                                    <td class="center">
                                        ...
                                        if(isset($_GET['search'])){
                                            $search = $_GET['search'];
                                            $query2="select * from gaji WHERE gaji LIKE '%$search%' order by id_gaji Asc";
                                        }else{
                                            $query2="select * from gaji order by id_gaji Asc";
                                        }
