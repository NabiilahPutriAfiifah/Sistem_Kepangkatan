                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        if($_GET['id_jabatan'] == null){
                            ...
                            $script = "SELECT * FROM jabatan WHERE id_jabatan = $id_jabatan";
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            //     $id_pegawai = $id['id_pegawai'];
                                ...
                                $script = "UPDATE jabatan SET id_pegawai='$id_pegawai', nama_jabatan='$nama_jabatan', tgl_jabatan='$tgl_jabatan' WHERE id_jabatan='$id_jabatan'";
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon"><i class="fa fa-calendar bigger-110"
                                                value="<?= $datapegawai['tgl_jabatan'] ?>"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
