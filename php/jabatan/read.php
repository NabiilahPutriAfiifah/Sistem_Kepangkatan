        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Kenaikan<small><i class="ace-icon fa fa-angle-double-right"></i> Jabatan <i
                            ...
                            <a type="button" class="label label-lg label-light arrowed-in arrowed-right"
                                href="create.php?page=form-master-data-pegawai"><i
                                    class="ace-icon fa fa-plus-circle bigger-110 blue"></i> Add Jabatan Pegawai
                                &nbsp;</a>
                        </small>
                    </h1>
                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="table-header" style="background-color: #307ECC; margin-bottom: 10px">
                                        Results <u><?php $script = "SELECT * FROM jabatan";
                                    ...
                                    <div>
                                        <?php
                                                ...
                                                if(isset($_GET['search'])){
                                                    $search = $_GET['search'];
                                                    $sql = "select * from jabatan WHERE nama_jabatan LIKE '%" .$search. "%' order by id_jabatan Asc limit $posisi, $batas";
                                                }else{
                                                    $sql = "select * from jabatan order by id_jabatan Asc limit $posisi,$batas";
                                                }

                                                
                                                    $sql2 = "SELECT id_jabatan, pegawai.nama as nama, nama_jabatan, tgl_jabatan FROM jabatan JOIN pegawai on jabatan.id_pegawai=pegawai.id_pegawai limit $posisi,$batas";
                                        ...
                                        <table id="dynamic-table"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">TANGGAL KENAIKAN JABATAN</th>
                                        ...
                                        if(isset($_GET['search'])){
                                            $search = $_GET['search'];
                                            $query2="select * from jabatan WHERE nama_jabatan LIKE '%$search%' order by id_jabatan Asc";
                                        }else{
                                            $query2="select * from jabatan order by id_jabatan Asc";
                                        }
