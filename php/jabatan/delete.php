...
if(isset($_POST["id_jabatan"]) && !empty($_POST["id_jabatan"])){
    // Include config file
    require "../../koneksi.php";
    ...
    if($stmt = mysqli_prepare($conn, $sql)){
        ...
        // Set parameters
        $param_id = trim($_POST["id_jabatan"]);
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Riwayat<small><i class="ace-icon fa fa-angle-double-right"></i> Jabatan <i
                                class="ace-icon fa fa-angle-double-right"></i> Delete Jabatan Pegawai &nbsp; <i
                ...
                <div class="wrapper">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="page-header">
                                    <h1>Delete Data Jabatan Pegawai</h1>
                                </div>
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    <div class="alert alert-danger fade in">
                                        <input type="hidden" name="id_jabatan"
                                            value="<?php echo trim($_GET["id_jabatan"]); ?>" />
