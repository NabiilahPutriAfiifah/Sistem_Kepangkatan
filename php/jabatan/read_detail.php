...
if($_GET['id_jabatan'] != null){
    $id_jabatan = $_GET['id_jabatan'];
    $script = "SELECT id_jabatan, pegawai.foto as foto, pegawai.nama as nama, pegawai.nip as nip, nama_jabatan, tgl_jabatan FROM jabatan JOIN pegawai on jabatan.id_pegawai=pegawai.id_pegawai WHERE id_jabatan=$id_jabatan";
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="page-header">
                    <h1>Data<small><i class="ace-icon fa fa-angle-double-right"></i> Jabatan <i
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <h4 class="blue"><span class="label label-lg label-purple arrowed-in-right">&nbsp;
                                        &nbsp; # Jabatan Pegawai &nbsp; &nbsp;</span></h4>

                                <div class="profile-info-row">
                                    <div class="profile-info-name"> ID Jabatan </div>
                                    <div class="profile-info-value"><span><?= $data['id_jabatan'] ?></span></div>
                                </div>
                                <div class="profile-info-row">
                                ...
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value"><span><?= $data['nama_jabatan'] ?></span>
                                    </div>
                                </div>
                                <div class="profile-info-row">
                                    <div class="profile-info-name"> Tanggal Kenaikan Jabatan </div>
                                    <div class="profile-info-value"><span><?= $data['tgl_jabatan'] ?></span></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-1 col-md-6">
                                    <a href="read.php" type="submit" class="btn btn-white btn-info btn-bold">Back</a>
                                </div>
                            </div>
                        </div>
                    </div>
