                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <h4 class="blue"><span class="label label-lg label-purple arrowed-in-right">&nbsp;
                                        &nbsp; # Biodata Pegawai &nbsp; &nbsp;</span></h4>
                                <div class="profile-user-info">
                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> Nama </div>
                                        <div class="profile-info-value">
                                            <span><strong><?= $data['nama'] ?></strong></span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value"><span><?= $data['no_telp'] ?></span></div>
                                    </div>
                                    <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value"><span><?= $data['status_pegawai'] ?></span>
                                        </div>
                                    </div>
                                </div>
