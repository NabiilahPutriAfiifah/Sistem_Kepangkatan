...
//chart
$arr_tampung1[1] = $arr_tampung["jumlah_pegawai"] = [];
$arr_tampung2[1] = $arr_tampung["jumlah_pegawai"] = [];
$arr_tampung3[1] = $arr_tampung["jumlah_pegawai"] = [];



$query = mysqli_query($conn, "SELECT status_pegawai, COUNT(*) as jumlah_pegawai FROM pegawai GROUP BY status_pegawai");
while($row = mysqli_fetch_assoc($query)) {
    $arr_tampung1["jumlah_pegawai"][] = $row["jumlah_pegawai"];
    $status_pegawai[] = $row['status_pegawai'];
}
$query = mysqli_query($conn, "SELECT jenis_kelamin, COUNT(*) as jumlah_pegawai FROM pegawai GROUP BY jenis_kelamin");
while($row = mysqli_fetch_assoc($query)) {
    $arr_tampung2["jumlah_pegawai"][] = $row["jumlah_pegawai"];
    $jenis_kelamin[] = $row['jenis_kelamin'];
}
$query = mysqli_query($conn, "SELECT agama, COUNT(*) as jumlah_pegawai FROM pegawai GROUP BY agama");
while($row = mysqli_fetch_assoc($query)) {
    $arr_tampung3["jumlah_pegawai"][] = $row["jumlah_pegawai"];
    $agama[] = $row['agama'];
}
?>
...
<body class="no-skin">
    ...
    <div class="main-container ace-save-state" id="main-container">
        ...
        <div id="sidebar" class="sidebar responsive ace-save-state">
            ...
            <ul class="nav nav-list">
                <li class=""><a href="index.php"><i class="menu-icon fa fa-tachometer"></i><span class="menu-text">
        ...
        <div class="main-content">
            <div class="main-content-inner">
                ...
                <div class="ace-settings-container" id="ace-settings-container">
                    <div class="btn btn-app btn-xs btn btn-outline-light me-1 ace-settings-btn" id="ace-settings-btn">
                ...
                <div class="page-header">
                    <h1>Dashboard<small> <i class="ace-icon fa fa-angle-double-right"></i> Overview
                            &nbsp;
                        </small>
                    </h1>
                </div>
                ...
                <center>
                    <div>
                        <div class="card" style="margin-bottom: 100px; margin-top: 80px">
                            <div class="card-body">
                                <h1><b>SISTEM KEPANGKATAN</b></h1><br>
                                <img src="img/bumn.png" alt="" srcset="">
                            </div>
                        </div>

                        <div style="padding-left: 30px; padding-right: 30px; margin-bottom: 100px; margin-top: 80px">
                            <div class="col-8 offset-2">
                                <div class="card">
                                    <div class="card-body">
                                        <h2><b>Grafik Jumlah Pegawai BUMN 2022-2023</b></h2>
                                        <hr>
                        ...
                        <div style="padding-left: 30px; padding-right: 30px; margin-bottom: 100px; margin-top: 80px">
                            <div class="col-8 offset-2">
                                <div class="card">
                                    <div class="card-body">
                                        <h2><b>Grafik Jenis Kelamin Pegawai BUMN 2022-2023</b></h2>
                                        <hr>
                                        <div class="chart-container"
                                            style="position: relative; height:40vh; width:80vw">
                        ...
                        <div style="padding-left: 30px; padding-right: 30px">
                            <div class="col-8 offset-2">
                                <div class="card">
                                    <div class="card-body">
                                        <h2><b>Grafik Agama Pegawai BUMN 2022-2023</b></h2>
                                        <hr>
                                        <div class="chart-container"
                                            style="position: relative; height:40vh; width:80vw">
    ...
    <script>
    var ctx = document.getElementById("ChartPegawai").getContext('2d');
    var ChartPegawai = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($status_pegawai); ?>,
            datasets: [{
                label: 'Jumlah Pegawai',
                data: <?php echo json_encode($arr_tampung1["jumlah_pegawai"]); ?>,
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(255, 159, 64, 0.2)',
                    // 'rgba(255, 205, 86, 0.2)',
    ...
    var ChartJenisKelamin = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Jumlah Pegawai',
                data: <?php echo json_encode($arr_tampung2["jumlah_pegawai"]); ?>,
                backgroundColor: [
                    'rgba(75, 192, 192, 0.2)',
                    'rgba(255, 99, 132, 0.2)'
                ],
    ...
    var ChartAgama = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Jumlah Pegawai',
                data: <?php echo json_encode($arr_tampung3["jumlah_pegawai"]); ?>,
                backgroundColor: [
                    'rgba(255, 99, 132, 0.2)',
                    'rgba(255, 159, 64, 0.2)',
                    'rgba(255, 205, 86, 0.2)',
